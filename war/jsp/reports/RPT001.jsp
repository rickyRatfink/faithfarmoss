			...
			<%  			
							...
							for (Entity result : entities) {
								...
								properties = result.getProperties();
							  	...
							  	if (properties.get("qtyFloor")!=null&&properties.get("qtyFloor").toString().length()>0) qty1=Integer.parseInt((String)properties.get("qtyFloor"));
							  		else qty1=0;
							  	if (properties.get("qtyWarehouse")!=null&&properties.get("qtyWarehouse").toString().length()>0) qty2=Integer.parseInt((String)properties.get("qtyWarehouse"));
							  		else qty2=0;
							  	int total = qty1+ qty2; 
								...
								if (row%2==0) bgcolor="FFFFFF";
							  	...
							  	<td class="report-field" bgcolor="<%=bgcolor%>"><%=properties.get("qtyFloor")%></td>
							  	<td class="report-field" bgcolor="<%=bgcolor%>"><fmt:formatNumber value="<%=qty1*cost%>" type="currency" /></td>
							  	<td class="report-field" bgcolor="<%=bgcolor%>"><%=properties.get("qtyWarehouse")%></td>
