...
<title>Faith Farm Ministries - Class Breakdown report</title>
...
<div id="container">
  ...
  <div class="wideBox">
    <h1><img src="<%=request.getContextPath()%>/images/logo.png" width="90" height="54" />Class Breakdown Report</h1>
    <p>Click a color in the chart, or an item in the table, to pull out a slice!</p>
  </div>
  ...
  <table id="chartData">
    ...
    <tr>
      <th>Class</th><th>Enrollment</th>
     </tr>

    <tr style="color: #0DA068">
      <td>Orientation</td><td><%=(Integer)session.getAttribute("class_0")%></td>
    </tr>

    <tr style="color: #194E9C">
      <td>1</td><td><%=(Integer)session.getAttribute("class_1")%></td>
    </tr>

    <tr style="color: #ED9C13">
      <td>2</td><td><%=(Integer)session.getAttribute("class_2")%></td>
    </tr>

    <tr style="color: #ED5713">
      <td>3</td><td><%=(Integer)session.getAttribute("class_3")%></td>
    </tr>

    <tr style="color: #057249">
      <td>4</td><td><%=(Integer)session.getAttribute("class_4")%></td>
    </tr>

    <tr style="color: #5F91DC">
      <td>5</td><td><%=(Integer)session.getAttribute("class_5")%></td>
    </tr>

    <tr style="color: #F88E5D">
      <td>6</td><td><%=(Integer)session.getAttribute("class_6")%></td>
    </tr>
  </table>
