...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Faith Farm Ministries - Departures Report
    </title>
  ...
  <div align="center">
    ...
    <table width="59%" cellspacing="0" cellpadding="0" border="0">
      ...
      %>
	  <tr>
	  	<td align="Left" colspan="2" valign="bottom"><h2><%=entities.size()%>&nbsp;&nbsp;Departures</h2></td>
	  </tr>
      <%
      ...
      for (int i=0;i<entities.size();i++) {
        ...
        <tr>
          <td width="352">
            ...
            %>
            <img src="<%=imageUrl%>" border="1" width="350" height="263"/>
          </td>
      ...
      <b>
        ...
        :&nbsp;
        <% 
        String exitDate=(String)properties.get("exitDate");
        if (exitDate!=null&&exitDate.length()>0) { %>
        	<%=exitDate%>
        <% } else { %>
        	<i>No exit date was entered for this resident.</i>	
        <% } %>
      </br>
      <b>
