...
String specialFilter=html.cleanData((String)session.getAttribute("special"));
                      ...
                      <td>
                        ...
                        <select name="special" class="ddlentry">
                          ...
                          if (ddl!=null) {
                            for (int j=0;j<ddl.size();j++) {
                              %>
                              <option value="<%=ddl.get(j)%>" <% if (ddl.get(j).equals(specialFilter)) {%>selected<%}%>>
                ...
                <table width="950" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;">
                  ...
                  for (int i=0;i<entities.size();i++) {
                    ...
                    if (cursor==0) {
                      %>
                      <tr>
                        <td class="results-bg" colspan="10">
                          no data found
                        </td>
                      </tr>
                      <%
